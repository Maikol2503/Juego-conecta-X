...
function nuevaPartida(){
	...
	contenedor1.html("");
	var p1 = $("<p>");
	var p2 = $(`<p class='marcador1 marcador'>${m1}</p>`);
	...
	var p2 = $(`<p class='marcador1 marcador'>${m2}</p>`);
...
function resetear(){
	if(confirm("Si Reseteas el juego se eliminaran las puntuaciones")){
		localStorage.setItem("c1", 0);  //reseteo valores del localStorage
